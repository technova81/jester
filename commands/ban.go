...
func (cmd *BanCmd) LongHelp() LongHelp {
	// return `This command bans a given user for specific days from the server.
	// 	**Usage:` + "`!ban @user [days] [reason]`" + `
	//   	**Arguments:**
	//   	* @user (Required): Mention the user to ban using the "@" symbol followed by their username.
	//   	* [days] (Required): Specify the duration of the ban in days. If omitted, the ban will be permanent.
	//   	* [reason] (Required): Provide a reason for the ban. This will be displayed to the user and logged for moderation purposes.`
